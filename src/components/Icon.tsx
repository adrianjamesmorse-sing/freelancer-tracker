...
const paths: Record<IconName, string> = {
  ...
  upload: 'M12 16V5m0 0-4 4m4-4 4 4M5 18.5h14',
  globe: 'M12 3.5a8.5 8.5 0 1 0 0 17 8.5 8.5 0 0 0 0-17Zm0 0c2.1 2.2 3.3 5.3 3.5 8.5-.2 3.2-1.4 6.3-3.5 8.5-2.1-2.2-3.3-5.3-3.5-8.5.2-3.2 1.4-6.3 3.5-8.5Zm-7.8 5h15.6M4.2 15.5h15.6',
  pin: 'M12 20s6-5.5 6-10a6 6 0 1 0-12 0c0 4.5 6 10 6 10Zm0-7.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z',
}
